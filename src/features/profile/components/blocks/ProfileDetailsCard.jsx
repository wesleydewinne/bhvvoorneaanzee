...
export default function ProfileDetailsCard({ profile, onProfileUpdated }) {
        ...
        <section className="profile-card">
            ...
            {!isEditing ? (
                <div className="profile-info-list">
                    <InfoRow icon={UserRound} label="Voornaam" value={profile.firstName} />
                    <InfoRow icon={UserRound} label="Achternaam" value={profile.lastName} />
                    ...
                    <InfoRow
                        ...
                        value={
                            Array.isArray(profile.globalRoles) && profile.globalRoles.length > 0
                                ? profile.globalRoles.map(formatRoleLabel).join(", ")
                                : "-"
                        }
                    />
                </div>
